...
<head>
    ...
    <title>Welcome to the Owner Team – BiteHub</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero { background: linear-gradient(135deg, #6366f1, #a855f7); padding: 60px 40px; text-align: center; }
...
<body>
    <div class="container">
        <div class="hero">
            ...
            <div class="logo">Bite<span>Hub</span> OWNER</div>
        </div>
        
        <div class="content">
            <h1 class="title">Elevating Your Access</h1>
            <p class="text">
                Hi {{ $details['name'] }},<br><br>
                Congratulations! You have been designated as an <strong>Owner</strong> of the BiteHub platform. This is the highest level of administrative privilege, giving you full oversight of the system, including admin management and detailed audit logs.
            </p>
            
            <div class="credentials-card">
                <div class="card-label">Your Secure Credentials</div>
                <div class="cred-item">
            ...
            <p class="text">
                You can now log in to the administrator dashboard to access the new <strong>Management</strong> and <strong>Audit Logs</strong> sections.
            </p>
        ...
        <div class="footer">
            <p>
                This is an automated security notification from <a href="{{ url('/') }}">BiteHub</a>.<br>
                Please change your password after your first login for maximum security.
            </p>
        </div>
    </div>
</body>
