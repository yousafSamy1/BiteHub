        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <form method="GET" action="{{ route('admin.categories') }}" class="d-flex gap-2">
                    ...
                    @if(request('search'))
                        <a href="{{ route('admin.categories') }}" class="btn btn-sm btn-outline-danger">✕</a>
                    @endif
                </form>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- Delete --}}
                                <form method="POST" action="{{ route('admin.categories.delete', $cat->CategoryID) }}"
                                      class="d-inline">
                                    @csrf @method('DELETE')
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Edit Category: <em>{{ $cat->CategoryName }}</em></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>
                            <form method="POST" action="{{ route('admin.categories.update', $cat->CategoryID) }}">@csrf
