...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <a href="{{ route('caterer.requests') }}" class="btn btn-sm btn-outline-secondary">
        <i data-feather="arrow-left" style="width:14px"></i> Back to Requests
    </a>
</div>
...
<div class="row g-4">
    <div class="col-lg-8">
        <div class="card d-flex flex-column" style="height: 750px;">
                    ...
                    <div class="card border-warning mb-3">
                        ...
                        <div class="card-body py-2">
                            ...
                            <div class="d-flex gap-2 align-items-end flex-wrap">
                                <form method="POST" action="{{ route('caterer.chat.approve', $msg->LiveChatID) }}" class="d-flex gap-2 align-items-end">
                                    @csrf
                                    <div>
                                ...
                                <form method="POST" action="{{ route('caterer.chat.reject', $msg->LiveChatID) }}">@csrf
            ...
            <div class="card-footer">
                ...
                <form method="POST" action="{{ route('caterer.orders.chat.send', $order->OrderID) }}" class="d-flex gap-2">
                    @csrf
    ...
    <div class="col-lg-4">
        <div class="card border-warning mb-3">
            ...
            <div class="card-body">
                <p class="text-muted small">Ask the customer to confirm or modify their catering details.</p>
                <form method="POST" action="{{ route('caterer.orders.chat.send', $order->OrderID) }}">
                    @csrf
                    <input type="hidden" name="type" value="request">
                    <textarea name="message" class="form-control mb-2" rows="3"
                              placeholder="e.g. Confirm the number of guests?" required></textarea>
                    <button class="btn btn-warning w-100"><i data-feather="send" style="width:14px"></i> Send Request</button>
                </form>
            </div>
        </div>
