...
<div class="row g-4">
    ...
    <div class="col-md-4">
        <div class="card h-100">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('caterer.categories.store') }}">
                    @csrf
                    <div class="mb-3">
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <form method="GET" action="{{ route('caterer.categories') }}" class="d-flex gap-2">
                    <input type="text" name="search" class="form-control form-control-sm"
                           placeholder="Search..." value="{{ request('search') }}">
                    <button class="btn btn-sm btn-outline-secondary">Go</button>
                    @if(request('search'))
                        <a href="{{ route('caterer.categories') }}" class="btn btn-sm btn-outline-danger">✕</a>
                    @endif
                </form>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- Delete --}}
                                <form method="POST" action="{{ route('caterer.categories.delete', $cat->CategoryID) }}"
                                      class="d-inline">
                                    @csrf @method('DELETE')
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('caterer.categories.update', $cat->CategoryID) }}">@csrf
