...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h5 class="mb-3"><i class="fas fa-clock me-2 text-warning"></i>Pending Requests</h5>
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="{{ route('kitchen.preorder.chat', [$req->MenuItemID ?? 0, $req->SenderID]) }}?session={{ $req->SessionID }}" class="btn btn-sm btn-outline-primary">
                                                ...
                                                @if(Auth::user()->Role !== 'Admin')
                                                    ...
                                                    <form action="{{ route('kitchen.chat.reject', $req->LiveChatID) }}" method="POST">
                                                        @csrf
                                            ...
                                            @if(Auth::user()->Role !== 'Admin')
                                                ...
                                                <div class="modal fade" id="approveModal{{ $req->LiveChatID }}" tabindex="-1" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <form action="{{ route('kitchen.chat.approve', $req->LiveChatID) }}" method="POST">
                                                            @csrf
