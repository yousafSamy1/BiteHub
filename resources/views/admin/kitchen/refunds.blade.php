                            ...
                            <tbody>
                                ...
                                <tr class="refund-row">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <a href="{{ $refund->RefundableType === 'Order' ? route('kitchen.orders') : '#' }}" class="text-custom-muted no-print" title="View Details">
                                    ...
                                    <td class="no-print">
                                        ...
                                        @endphp
                                        <a href="{{ route('kitchen.support') }}?subject=Dispute Refund #{{ $refund->RequestID }}&message={{ urlencode($details) }}&order_id={{ $orderId }}" class="btn btn-sm btn-outline-warning d-inline-flex align-items-center gap-1" style="border-radius: 8px; font-size: 0.75rem;">
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        ...
                                        <h5 class="text-custom-muted">No refunds processed for your kitchen yet.</h5>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
...
<script>
    ...
    function exportToCSV() {
        ...
        downloadLink.download = "kitchen-refunds-report.csv";
