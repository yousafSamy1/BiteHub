...
<div class="promo-card">
    ...
    <div id="createFormPanel" class="create-form-panel d-none">
        ...
        <form method="POST" action="{{ route('kitchen.promo_codes.store') }}">
            @csrf
            <div class="row g-3">
                <div class="col-md-3">
                    <label>Code</label>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            {{-- Toggle --}}
                            <form method="POST" action="{{ route('kitchen.promo_codes.toggle', $promo->PromoCodeID) }}" style="display:inline;">
                                @csrf
                            ...
                            @endif
                            {{-- Delete --}}
                            <form method="POST" action="{{ route('kitchen.promo_codes.delete', $promo->PromoCodeID) }}" style="display:inline;" onsubmit="return confirm('Delete this promo code?')">
                                @csrf @method('DELETE')
                ...
                <div class="modal fade modal-promo" id="editModal{{ $promo->PromoCodeID }}" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('kitchen.promo_codes.update', $promo->PromoCodeID) }}">
                                @csrf
...
function executeAnnounce(id, btn) {
    ...
    fetch(`/admin/kitchen/promo-codes/${id}/announce`, {
        method: 'POST',
        headers: {
