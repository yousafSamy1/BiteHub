...
<div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
        <div>
            <h3 class="heading-main mb-1">{{ $kitchen->KitchenName }} Performance</h3>
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <a href="{{ route('kitchen.orders', ['type' => 'standard']) }}" class="text-decoration-none">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <a href="{{ route('kitchen.refunds') }}" class="text-decoration-none">
    ...
    <!-- Row 3: Subscriptions & Products -->
    <div class="row mb-4">
        <div class="col-md-3">
            <a href="{{ route('kitchen.subscriptions') }}" class="text-decoration-none">
                <div class="dark-card p-3" style="cursor: pointer;">
                    <div class="d-flex justify-content-between mb-2">
                        <p class="stat-title">Active Subscriptions</p>
                        <div class="icon-box-dark icon-info"><i data-feather="repeat" style="width:18px"></i></div>
                    </div>
        ...
        <div class="col-md-3">
            <a href="{{ route('kitchen.subscriptions') }}" class="text-decoration-none">
                <div class="dark-card p-3" style="cursor: pointer;">
                    <div class="d-flex justify-content-between mb-2">
                        <p class="stat-title">Monthly Sub Revenue</p>
                        <div class="icon-box-dark icon-success"><i data-feather="layers" style="width:18px"></i></div>
                    </div>
                    <h4 class="stat-value">{{ number_format($subscriberRevenue, 2) }} <small class="text-custom-muted fs-6">EGP</small></h4>
                </div>
            </a>
        </div>
        <div class="col-md-3">
            <a href="{{ route('kitchen.menu') }}" class="text-decoration-none">
                <div class="dark-card p-3" style="cursor: pointer;">
                    <div class="d-flex justify-content-between mb-2">
        ...
        <div class="col-md-3">
            <a href="{{ route('kitchen.ads') }}" class="text-decoration-none">
                <div class="dark-card p-3" style="cursor: pointer;">
                    <div class="d-flex justify-content-between mb-2">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <a href="{{ route('kitchen.support') }}" class="text-decoration-none">
                <div class="dark-card p-3" style="cursor: pointer;">
        ...
        <div class="col-12">
            <a href="{{ route('kitchen.orders', ['type' => 'standard']) }}" class="text-decoration-none">
                <div class="dark-card p-4" style="cursor: pointer;">
                    ...
                    <div id="kitchenRevenueChart" style="height: 350px;"></div>
                </div>
            </a>
        </div>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if(document.querySelector("#kitchenRevenueChart")) {
            new ApexCharts(document.querySelector("#kitchenRevenueChart"), options).render();
        }
    });
</script>
@endpush
