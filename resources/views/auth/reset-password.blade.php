...
<head>
    ...
    <title>Reset Password — BiteHub</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        [data-theme="dark"] {
            ...
            --placeholder:  #444444;
            --toggle-color: #555555;
            --strength-bg:  rgba(255,255,255,0.07);
            --strength-label: #555555;
        ...
        [data-theme="light"] {
            ...
            --placeholder:  #aaaaaa;
            --toggle-color: #aaaaaa;
            --strength-bg:  rgba(0,0,0,0.07);
            --strength-label: #aaaaaa;
        ...
        .input-wrap .toggle-pw:hover { color: #ff6b35; }
        ...
        .strength-bar { height: 4px; border-radius: 4px; background: var(--strength-bg); overflow: hidden; transition: background 0.3s; }
        .strength-fill { height: 100%; border-radius: 4px; width: 0%; transition: width 0.35s, background 0.35s; }
        .strength-label { font-size: 0.72rem; color: var(--strength-label); margin-top: 5px; font-weight: 600; transition: color 0.3s; }
        ...
        .divider span { font-size: 0.75rem; color: var(--footer-link); font-weight: 600; text-transform: uppercase; letter-spacing: 1px; transition: color 0.3s; }
...
<div class="card">
    ...
    <p class="subtext">
        Choose a strong password for your BiteHub account.<br>Make sure it's at least 8 characters.
    </p>
        ...
        <div class="field">
            ...
            <div class="input-wrap">
                ...
                <input
                    ...
                    autocomplete="new-password"
                >
                <span class="toggle-pw" onclick="togglePw('password_confirmation', this)">👁️</span>
            </div>
